  ...
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center px-4 text-center">
      <div className="max-w-md space-y-4">
        ...
        <h2 className="text-xl font-semibold">Analytics temporarily unavailable</h2>

        <p className="text-sm text-muted-foreground">
          We couldn't load your analytics data. Please try again or return to the dashboard.
        </p>
